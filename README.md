...
## Overview
이런 PFD를 구현하기 위해 사용한 마이크로컨트롤러는 아두이노 UNO, 거기에 자이로/가속도 센서인 MPU6050을 결선하여 기반을 잡았으며, 
...
현재 구현된 PFD는 속도, 고도, 자세 등을 시각화 해주는 실제 항공기의 PFD를 그대로 구현했다기보다는, PFD의 핵심 개념 중 자세(Attitude) 정보를 중심으로 구현한 프로토타입에 가깝습니다. 따라서 앞으로는, 실제 PFD에서 사용되는 대기속도, 고도, 수직속도 등의 데이터를 추가하여 개선할 수 있을 것 같습니다. 
